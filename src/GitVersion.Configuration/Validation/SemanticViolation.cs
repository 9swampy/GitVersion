...
/// </param>
/// <param name="Title">
/// Short human-readable name for the violated rule, e.g. "Authority/Carrier Exclusivity".
/// Used by dashboards and CI tools to group violations by rule without parsing RuleId.
/// </param>
...
{
    /// <summary>
    /// Informational only. Explains surprising but legal behaviour where intent
    /// and runtime semantics may not align. Never blocks CI (exit code 0).
    /// </summary>
    Advisory,
    Warning,
    Error
